...
const eventsArray = [
    ...
    {date: "2022-09-23",event: "Réunion générale (parents) - Premières / Terminales"},
    {date: "2022-09-20",event: "Journée à Dinard - Secondes Euro / Terminales AMC"},
    {date: "2022-09-16",event: "Réunion générale (parents) - Secondes"},
